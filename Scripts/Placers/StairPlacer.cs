...
[Obsolete]
/// <summary>
/// Instance this to create a staircase drop from given start piece.
/// It checks for possibility in construction but doesn't add the keys until the Build() is called
/// </summary>
